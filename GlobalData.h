...
// use GlobalData::GetInstance() to access this class. Example: GlobalData::GetInstance().miss_count
class GlobalData {
public:
    ...
    QString end_text_default = QObject::tr("Congratulation! You have found a way to close me. Have a great day!");
    QString end_text_1 =
